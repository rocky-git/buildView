...
$(function () {
    ...
    $.fn.uploadOneImage = function () {
        ...
        console.log(name);
        var type = $(this).data('type') || 'png,jpg,jpeg';
        //获取宽高
        var width = $(this).data('width') ||'';
        var height = $(this).data('height') ||'';
        var $tpl = $('<a data-file="one" data-width="'+width+'" data-height="'+height+'" data-field="' + name + '" data-type="' + type + '" class="uploadimage"></a>');
    ...
    $.fn.uploadMultipleImage = function () {
        ...
        var $tpl = $('<a data-file="mut" data-field="' + name + '" data-type="' + type + '" data-width="'+width+'" data-height="'+height+'" class="uploadimage"></a>');
        $(this).hide().attr('name', name).after($tpl).on('change', function () {
            ...
            for (var i in values) {
                ...
                $tpl.on('click', 'a', function (e) {
                    ...
                    var dialogIndex = $.msg.confirm('确定要移除这张图片吗？', function () {
                        var data = $cur.data('input').value.split("|"),tmp = [];
    ...
    $body.on('click', '[data-file]', function () {
        ...
        var width = $(this).data('width')|| '';
        var height = $(this).data('height')||'';
        var url = window.ROOT_URL + '/admin/plugs/upfile.html?mode=' + method + '&uptype=' + uptype + '&type=' + type + '&field=' + field + '&width=' + width + '&height=' + height;
